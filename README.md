...
We experimented with adapting anywhere from 2 to 6 layers, gradually adjusting the range to observe performance changes. Ultimately, we settled on adapting 3 layers (layers 9–11), which consistently produced the most balanced results in terms of accuracy and stability.  
